...
(function() {
    ...
    var removeDownloadfile = {
        ...
        removeMenu: function (contextMenuId) {
            ...
            let menuitem = document.getElementById("removeDownload") || document.createElement("menuitem"),
	...
	function autoClose_blankTab() {
		eval("gBrowser.TabProgressListener = " + gBrowser.TabProgressListener.toString().replace(/(?=var location)/, '\
