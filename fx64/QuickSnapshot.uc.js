...
function takeSnapshot() {FileUtils.getFile('UChrm',['Local', 'QuickSnapshot','Snapshot.exe']).launch();};
function  takeSnapshotHide() {window.minimize(); FileUtils.getFile('UChrm',['Local', 'QuickSnapshot','Snapshot.exe']).launch();};
function	takeSnapShotGIF() { FileUtils.getFile('UChrm',['Local', 'QuickSnapshot','ScreenToGif.exe']).launch();};
function	takeSnapShotColor() { FileUtils.getFile('UChrm',['Local', 'QuickSnapshot','Colors','Colors.exe']).launch();};
function	takeSnapshotFSCapture() { FileUtils.getFile('UChrm',['Local', 'QuickSnapshot','FSCapture','FSCapture.exe']).launch();};
...
function	UploadImages() {window.open('moz-extension://4c0faf8b-9384-4f1d-bf4a-08f0fb2569f4/pages/tuchuang.html','新浪图床','resizable,scrollbars,status,title').resizeTo(400, 400);};
